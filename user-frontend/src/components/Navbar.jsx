...
const indianLocations = {
  ...
  "Rajasthan": {
    districts: {
      ...
      "Sri Ganganagar": ["Sri Ganganagar", "Hanumangarh", "Rawatsar", "Karanpur"],
      ...
      "Sri Ganganagar": ["Sri Ganganagar", "Raisinghnagar", "Anupgarh", "Vijaypur"],
  ...
  "Telangana": {
    districts: {
      ...
      "Medak": ["Medak", "Siddipet", "Dubbak", "Tuljapur"],
      "Medchal–Malkajgiri": ["Medchal", "Malkajgiri", "Keesara", "Qutubullapur"],
      "Medak": ["Medak", "Siddipet", "Narsapur", "Papannapet"],
